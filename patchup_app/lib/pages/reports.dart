//
// Displays community pothole reports, heatmap visualization, filters, and report details.
//
...
// Main state for ReportsPage: manages filters, loading, and UI sections
class _ReportsPageState extends State<ReportsPage> {
  ...
  String _formatDateTime(String raw) {
    ...
    final appLoc = AppLocalizations.of(
      context,
    ); // moved earlier for localization
  ...
  // Builds heatmap visualization section for all reports
  ...
  // Builds reports list section with filtering
...
class _ReportCard extends StatelessWidget {
  ...
  final String Function(String) formatDateTime; // kept for compatibility
    ...
    return Container(
      ...
      child: Stack(
        children: [
              ...
              child:
                  report['ImageURL'] != null &&
                      ...
                      ? Image.network(
                        ...
                        fit: BoxFit.cover,
                        errorBuilder:
                            (ctx, __, ___) => _buildImagePlaceholder(ctx),
                      )
          ...
          // Top badges (severity / status + validation)
          Positioned(
            top: 12,
            left: 12,
            right: 12,
