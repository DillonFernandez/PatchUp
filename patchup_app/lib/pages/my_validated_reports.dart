//
// Displays user's validated pothole reports with heatmap visualization, filters, and detailed report cards.
//
...
// Fetches heatmap points for the current user's validated reports
Future<List<WeightedLatLng>> fetchUserHeatmapPoints() async {
  final response = await http.post(
    ...
    body: jsonEncode({'UserEmail': UserSession.email, 'mode': 'validated'}),
  );
...
// Fetches reports that the logged-in user has validated
Future<List<Map<String, dynamic>>> fetchUserReports() async {
  final response = await http.post(
    Uri.parse(
      'http://192.168.8.187/patchup_app/lib/api/display_validated_reports.php',
    ),
    headers: {'Content-Type': 'application/json'},
...
class MyValidationsPage extends StatefulWidget {
  @override
  State<MyValidationsPage> createState() => _MyValidationsPageState();
}

// Main state for MyValidationsPage: manages filters, loading, and UI sections
class _MyValidationsPageState extends State<MyValidationsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          appLoc.translate('My Validations'), // changed from 'My Reports'
  ...
  // Builds heatmap visualization section
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      appLoc.translate('My Validations Heatmap'), // changed
                      style: TextStyle(
                        fontSize: 18,
                    ...
                    Text(
                      appLoc.translate(
                        'Your validated report distribution',
                      ), // changed
                      style: TextStyle(
                        fontSize: 12,
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(
                      appLoc.translate("Filter Validations"), // changed
                      style: TextStyle(
                        fontSize: 16,
  ...
  // Builds validated reports list section with filtering
    ...
    return Column(
      children: [
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      appLoc.translate('My Validations'), // changed
                      style: TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.w800,
                        color: Colors.white,
                    ...
                    Text(
                      appLoc.translate('Your validated reports'), // changed
                      style: TextStyle(
                        fontSize: 12,
                        fontWeight: FontWeight.w500,
                        color: Colors.white.withOpacity(0.8),
        ...
        FutureBuilder<List<Map<String, dynamic>>>(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              return _buildReportsLoading(); // text inside updated below
            }
            if (_isOffline) {
            ...
            final filteredReports =
                reports.where((report) {
                  ...
                  if (!_isValidated(report)) return false;
                  if (selectedStatus != null &&
                      (report['Status'] == null ||
            ...
            if (filteredReports.isEmpty) {
              return _buildReportsEmpty(appLoc); // text inside updated below
            }
        ...
        child: Column(
          children: [
            ...
            Text(
              AppLocalizations.of(
                context,
              ).translate('Loading validated reports...'), // changed
              style: TextStyle(
                fontSize: 14,
                fontWeight: FontWeight.w500,
                color: Colors.blueGrey[600],
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 10),
          Text(
            appLoc.translate('No validated reports found.'), // changed
            style: TextStyle(
              fontSize: 15,
              color: Colors.grey[600],
              fontWeight: FontWeight.w600,
  ...
  // Helper: checks if report is validated
  bool _isValidated(Map<String, dynamic> report) {
...
// Dropdown widget for filter controls
...
// Report card widget for displaying report details
class _ReportCard extends StatelessWidget {
  ...
  // Builds badges and user info overlays
  ...
  // Builds location and description content section
